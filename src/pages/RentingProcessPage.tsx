...
interface RentingProcessPageProps {
...
const steps = [
{
  ...
  description:
  'Fill out our simple facility needs assessment form online or by phone. Tell us about your clinical requirements, patient volume, and preferred rent term.',
  details: [
...
},
{
  ...
  description:
  'Sign your flexible rent agreement with transparent terms — no hidden fees. Our team responds within 24 hours; most equipment arrives within 30 days due to sea imports and is then installed and tested promptly.',
  details: [
...
},
{
  ...
  description:
  'Your rent includes comprehensive support throughout the entire term. Our Kodiscan-based technicians are available 24/7 for emergencies.',
  details: [
...
const faqs = [
{
  q: 'What is the minimum rent term?',
  a: "Our minimum rent term is 12 months. We offer flexible terms from 12 to 60 months, allowing you to choose a plan that fits your facility's budget and operational planning cycle."
},
{
...
},
{
  ...
  a: 'Yes. We offer equipment upgrade options at any point during your rent term. If newer technology becomes available, you can upgrade with a simple rent agreement amendment — no penalties for early upgrades.'
},
{
